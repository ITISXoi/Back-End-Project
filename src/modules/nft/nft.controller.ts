...
export class NftController {
    ...
    async createOffchain(
        ...
        const nftOffchain = await this.nftService.createOffchain(data, files, NftOffChainType.DRAFT, request.user);
    ...
    async getListNfts(
        ...
        console.log("name, chainId, collectionId, contractAddress",name, chainId, collectionId, contractAddress);
        return this.nftService.getListNfts({name, chainId, collectionId, contractAddress}, {page, limit});
    }
    ...
    async getNfts(
        ...
        return this.nftService.getListNfts({name, chainId, collectionId, contractAddress, userId: request.user.id}, {page, limit});
    }
